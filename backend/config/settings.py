...
STATIC_URL = "static/"
STATICFILES_DIRS = [BASE_DIR.parent / "plots"]  # Points to /plots at root level
...
# CORS Configuration - Allow frontend to access API from different origins
CORS_ALLOWED_ORIGINS = env.list(
    ...
    default=[
        ...
        "https://www.agilepredict.com",
    ]
)

CORS_ALLOW_CREDENTIALS = True

# REST Framework Configuration - Configure DRF for API-first approach
REST_FRAMEWORK = {
